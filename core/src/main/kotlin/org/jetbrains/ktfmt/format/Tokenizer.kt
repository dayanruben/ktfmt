      ...
      is PsiComment -> {
        ...
        toks.add(
            KotlinTok(
                ...
                column = columnAt(element.startOffset),
                isToken = treatAsToken,
                kind = KtTokens.EOF,
                originalLineIndent = lineIndentAt(element.startOffset),
          ...
          while (matcher.find()) {
            ...
            toks.add(
                KotlinTok(
                    ...
                    column = columnAt(element.startOffset + matcher.start()),
                    isToken = false,
                    kind = KtTokens.EOF,
                    originalLineIndent = lineIndentAt(element.startOffset + matcher.start()),
                ),
            )
          }
        } else {
