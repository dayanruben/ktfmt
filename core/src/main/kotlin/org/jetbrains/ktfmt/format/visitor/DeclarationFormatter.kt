...
internal open class DeclarationFormatterImpl : DeclarationFormatter {
  context(_: FormatterStateHolder)
  protected fun isKotlinlangStyle(): Boolean =
  ...
  override fun formatNamedFunction(function: KtNamedFunction) {
    ...
    builder.block {
      emitFunctionDeclaration(
          ...
          forceAnnotationLineBreaks = isKotlinlangStyle(),
      )
    }
  }
  ...
  override fun formatClassOrObject(classOrObject: KtClassOrObject) {
    ...
    builder.block {
      ...
      if (modifierList != null) {
        formatModifierList(modifierList, forceAnnotationLineBreaks = isKotlinlangStyle())
      }
    ...
    builder.block {
      ...
      if (destructuringDeclaration != null) {
        ...
        emitPropertyDeclaration(
            ...
            forceAnnotationLineBreaks =
                isKotlinlangStyle() && parameter.valOrVarKeyword != null,
        )
      }
    }
  }
  ...
  open fun emitPropertyDeclaration(
      ...
      forceAnnotationLineBreaks: Boolean = false,
  ) {
    if (modifiers != null) {
      formatModifierList(modifiers, forceAnnotationLineBreaks)
    }
    builder.block {
      builder.block {
        if (valOrVarKeyword != null) {
  ...
  open fun emitFunctionDeclaration(
    ...
    builder.block(ZERO, isEnabled = hasName) {
      ...
      if (modifierList != null) {
        formatModifierList(modifierList, forceAnnotationLineBreaks)
      }
      if (keyword != null) {
