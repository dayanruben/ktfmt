...
interface ListFormatter {
  ...
  /**
   * Emits a type-argument list as one unit without internal breaks, so that outer chain breaks
   * are preferred over breaking inside the chevrons (issues 207, 257).
   */
  context(_: FormatterStateHolder)
