...
internal class LongStringLiteralFormatter(
  ...
  fun format(code: KotlinCode): KotlinCode {
    ...
    return code.copy(result.toString())
  }

  private fun getLongStringLiteralReplacements(code: KotlinCode): List<LongStringLiteralReplacement> {
